...
This workspace includes a modern responsive admin dashboard implemented with React, TypeScript and Tailwind CSS under `src/layouts` and `src/components`.

To finish setup locally run:

```bash
npm install -D tailwindcss postcss autoprefixer
# (optional) if you haven't initialized Tailwind already
